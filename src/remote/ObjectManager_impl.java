...
public class ObjectManager_impl implements ObjectManager {
	...
	@Override
	public <Model extends BaseModel, S extends BackingStore<Model>> boolean registerStore(
			S e) {
	...
	@Override
	public <Model extends BaseModel, S extends BackingStore<Model>> void deactivateStore(
			S e) {
